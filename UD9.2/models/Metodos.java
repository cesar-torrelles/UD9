...
public class Metodos {
	public static void llenarVectores (Serie [] series, Videojuego [] videojuegos) {
		//Series
		series [0] = new Serie ("La casa de papel", 4, "robo", "�lex Pina");
		series [1] = new Serie ("Prison Break", 5, "drama", "Paul Scheuring ");
		series [2] = new Serie ("Hache", 1, "suspenso", "Ver�nica Fern�ndez");
		series [3] = new Serie ("You", 2, "suspenso", "Sera Gamble");
		series [4] = new Serie ();
		
		//Videojuegos
		videojuegos [0] = new Videojuego ("Grand Theft Auto V", 50, "aventura", "Rockstar North");
		videojuegos [1] = new Videojuego ("Fortnite",0, "acci�n", "Epic Games");
		videojuegos [2] = new Videojuego ("FIFA 21", 20, "f�tbol", "EA Sports");
		videojuegos [3] = new Videojuego ("Assassin's Creed", 75, "acci�n-aventura", "Ubisoft Montreal");
	...
	public static void masHoras_temporadas (Videojuego [] videojuegos, Serie [] series) {
		...
		System.out.println("El videojuego con m�s horas estimadas �s:");
		...
		System.out.println();
		System.out.println("La serie con m�s temporadas �s:");
