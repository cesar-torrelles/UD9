...
//Creamos una Clase llamada Raices
public class raices {

	// Creamos sus Atributos
	// tres de tipo double que representaran los valores de las incognitas y uno tipo char
	// para representar el signo inicial
	protected double a;
	protected double b;
	protected double c;
	protected char signoInicial;

	// Creamos su Constructor donde asignaremos a nuestro objeto los valores antes mencionados
	...
	// Un metodo de tipo booleano que nos determinara si la ecuacion tiene dos raices
	...
	/*
		Al resolver una ecuación de segundo grado, pueden ocurrir 3 cosas:
			...
			Existen 2 valores para la variable que satisfacen la ecuación.
	...
	*/
	...
	// y en caso de que la solucion tenga solo un valor podremos imprimirlo mediante este metodo
	public static void obtenerRaiz(double a, double b, double c, char signoNegativo) {
		...
		//Si queremos saber cuanto da la raiz cuadrada del determinante habilitamos el codigo siguiente:
		//System.out.println("raiz cuadrada del determinante: " + raizCuadradaDelDiscriminante);
	...
	// y en caso de que la solucion tenga dos valores podremos imprimirlos mediante este metodo
	public static void obtenerRaices(double a, double b, double c, char signoNegativo) {
		...
		//Si queremos saber el valor de la operacion A, habilitamos el codigo siguiente:
		//System.out.println("valor de la operacion A: " + operacionA);
	...
	//creamos un ultimo metodo para que automaticamente realice el calculo y nos de el resultado correcto
	// determinando si la ecuacion tiene uno o dos raices 
	// en cualquiera de los casos llama al metodo correspondiente encargado de calcularlo
